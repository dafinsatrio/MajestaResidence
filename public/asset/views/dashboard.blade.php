			...
			<nav class="navbar navbar-default">
				<div class="container">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand nav-item" href="{{ route('dashboard') }}"><img src="images/majesta.png" alt="logo" style="height: 54px; width: 84px;" /></a>
					</div>
                    ...
                    <ul class="navbar-right pt-30">
						...
						<ul class="nav nav-list navbar-nav navbar-right">
							<li><a class="nav-item" href="">Tipe Rumah</a></li>
							<li><a class="nav-item" href="">Gallery</a></li>
                            <li><a class="nav-item" href="">Booking Pertemuan</a></li>
							<li><a class="nav-item" href="">Simulasi KPR</a></li>
